    ...
    <div className="gd-root">
      ...
      <section className="gd-kpis">
        <div className="gd-kpi glass">
          <div className="gd-kpi-icon gd-tone-red"><Icon name="home" size={26} /></div>
          <div>
        ...
        <div className="gd-kpi glass">
          <div className="gd-kpi-icon gd-tone-orange"><Icon name="alert" size={26} /></div>
          <div>
        ...
        <div className="gd-kpi glass">
          <div className="gd-kpi-icon gd-tone-green"><Icon name="shield" size={26} /></div>
          <div>
        ...
        <div className="gd-kpi glass">
          <div className="gd-kpi-icon gd-tone-purple"><Icon name="users" size={26} /></div>
          <div>
        ...
        <div className="gd-panel gd-quick glass">
          ...
          <div className="gd-quick-grid">
            <div className="gd-qcard">
              <div className="gd-qicon gd-tone-blue"><Icon name="database" size={18} /></div>
              <div>
            ...
            <div className="gd-qcard">
              <div className="gd-qicon gd-tone-purple"><Icon name="file" size={18} /></div>
              <div>
            ...
            <div className="gd-qcard">
              <div className="gd-qicon gd-tone-red"><Icon name="alert" size={18} /></div>
              <div>
            ...
            <div className="gd-qcard">
              <div className="gd-qicon gd-tone-green"><Icon name="shield" size={18} /></div>
              <div>
